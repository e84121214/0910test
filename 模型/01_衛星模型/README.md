...
本次使用單層 GRU 與 64 hidden units。最多 30 輪的訓練於第 11 輪提前停止，最佳權重為第 6 輪；驗證集選出的門檻為 0.70。

| 測試集 | TP | FP | FN | Precision | Recall | CSI |
|---|---:|---:|---:|---:|---:|---:|
| 時間測試 | 125 | 130 | 312 | 49.02% | 28.60% | 22.05% |
| 空間測試 C48 | 4 | 22 | 90 | 15.38% | 4.26% | 3.45% |

時間測試仍漏掉 312/437 筆霧，C48 仍漏掉 90/94 筆霧；模型已可運作，但跨站泛化仍弱。
